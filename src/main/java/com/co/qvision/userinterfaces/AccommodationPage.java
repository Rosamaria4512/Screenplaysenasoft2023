...
public class AccommodationPage {
    ...
    public static final Target SLT_FILTER_1=Target.the("Seleeccioner un filtro").locatedBy("(//div[@data-filters-item='used_filters:ht_id=204']//input[@type='checkbox'])[1]");
